#!/usr/bin/env python3
"""Check the expanded Plain-English run; train only with explicit --run.
...
DATA = HERE / "datasets" / "plain_english_2k"
OUTPUT = PROJECT / "adapters" / "qwen3-8b-plain-english-2k"
SETTINGS = {
...
CODE_FILES = (
    "train_plain_english_2k.py",
    "train_lora.py",
    "chat_examples.py",
    "validation_samples.py",
    "evaluate_plain_english.py",
    "datasets/plain_english_2k/validate.py",
    "datasets/plain_english_2k/build.py",
)
...
def main():
    ...
    for name in ("train.jsonl", "validation.jsonl", "manifest.json", "validation_sample_ids.json"):
