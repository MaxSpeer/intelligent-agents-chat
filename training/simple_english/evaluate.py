#!/usr/bin/env python3
"""Compare the selected Simple English adapter and base model on the held-out test split."""
...
DEFAULT_ADAPTER = PROJECT / json.loads((Path(__file__).with_name("selection.json")).read_text())["adapter_path"]
...
def main():
    ...
    parser.add_argument("--results-dir", type=Path, default=PROJECT / "logs" / "simple-english-evaluation")
