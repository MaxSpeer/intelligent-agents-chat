"""Build Qwen3 SFT examples without importing a model or a GPU framework.

Each assistant answer is the final turn of its own example. Earlier answers
remain in the masked context. This matters for Qwen3: its template inserts an
empty thinking block into the final assistant turn, but not historical turns.
Lengths of separately rendered conversation prefixes therefore cannot locate
all assistant spans inside one full conversation.
"""
